...
export default function Home() {
  return (
    <>
      ...
      <section
        id="hero"
        className="relative overflow-hidden bg-gradient-to-br from-warm via-background to-secondary-light/20"
      >
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <AnimatedSection delay={150}>
              <div className="grid grid-cols-2 gap-4">
                {[
                  { icon: "❤️", label: "Bonding", desc: "Perkuat ikatan orang tua & anak" },
                  { icon: "🧠", label: "Edukatif", desc: "Stimulasi perkembangan optimal" },
                  { icon: "🎨", label: "Kreatif", desc: "Aktivitas seru & imajinatif" },
                  { icon: "🏠", label: "Praktis", desc: "Mudah dilakukan di rumah" },
                ].map((item) => (
                  <div
                    key={item.label}
      ...
      <AnimatedSection>
        <section className="py-16 md:py-24 bg-secondary-light/10">
          <div className="max-w-6xl mx-auto px-4 text-center">
            ...
            <p className="text-foreground/60 max-w-lg mx-auto mb-12">
              Kami percaya setiap momen bermain adalah kesempatan berharga
              untuk belajar dan tumbuh bersama.
            </p>
            <div className="grid md:grid-cols-3 gap-8">
              {[
                { emoji: "🤗", title: "Bonding Berkualitas", description: "Aktivitas dirancang untuk memperkuat ikatan emosional antara orang tua dan anak melalui momen bermain yang bermakna." },
                { emoji: "📚", title: "Stimulasi Tepat", description: "Setiap aktivitas mendukung aspek perkembangan spesifik — bahasa, motorik, sosial, dan kognitif." },
                { emoji: "✨", title: "Mudah & Praktis", description: "Menggunakan bahan sederhana yang tersedia di rumah. Tidak perlu persiapan rumit untuk mulai bermain." },
              ].map((item) => (
                <div
                  key={item.title}
